...
export default function DashboardPage() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-white dark:bg-slate-900 text-sm text-slate-700 dark:text-slate-300 font-sans">
        <Loader2 className="mr-2 h-5 w-5 animate-spin text-emerald-600 dark:text-emerald-400" /> Loading MediChain Ledger...
      </div>
    );
  }
        ...
        <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-6 md:px-8">
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="hidden text-lg font-bold tracking-tight text-slate-900 dark:text-white sm:block font-sans">
