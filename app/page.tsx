...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-600 selection:text-white">
      ...
      {/* Metrics Banner */}
      <section className="relative z-10 border-t border-b border-slate-200 bg-slate-50/70 py-12">
        <div className="mx-auto max-w-[1440px] px-6 md:px-8">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {STATS.map((stat) => (
              <div key={stat.label} className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm font-sans">
