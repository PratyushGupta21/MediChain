...
export default function PharmacistHub() {
  ...
  if (user?.role !== 'PHARMACIST') {
    return (
      <AccessRestricted
        title="Access Restricted: Licensed Pharmacists Only"
        description="CDSCO Rule 96 verification tools and Polygon EIP-712 signing are reserved exclusively for licensed pharmacists."
        footer="State Pharmacy Council registration & CDSCO Inspector credentials required for cryptographic signature generation."
      />
    );
  }
