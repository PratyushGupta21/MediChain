...
export default function HouseholdPortal() {
  ...
  if (user?.role !== 'HOUSEHOLD') {
    return (
      <AccessRestricted
        title="Access Restricted: Household Donors Only"
        description="This cabinet management and waste scanning hub is reserved exclusively for registered household accounts."
        footer="Household profile authentication required for medicine inventory tracking, donation listings, and disposal requests."
      />
    );
  }
